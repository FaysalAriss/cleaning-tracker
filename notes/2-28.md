...
I'm still having issues flashing the board. Online it says to connect the boot0 pin which to 3.3v and toggle nrst to gnd which i can do using the button. It seems to have worked, i need to look into why it works if it keeps working. I also wanna know why i can short the pin straight to 3.3v. I used a dupont for that.

I used the new batter holder with the final battery to be used and it works great.
