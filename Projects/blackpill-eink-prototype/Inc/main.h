...
#define SWITCH_LEFT_Pin GPIO_PIN_8
#define SWITCH_LEFT_GPIO_Port GPIOA
#define SWITCH_LEFT_EXTI_IRQn EXTI9_5_IRQn
#define SWITCH_RIGHT_Pin GPIO_PIN_9
#define SWITCH_RIGHT_GPIO_Port GPIOA
#define SWITCH_RIGHT_EXTI_IRQn EXTI9_5_IRQn
#define RTC_INTERRUPT_Pin GPIO_PIN_5
#define RTC_INTERRUPT_GPIO_Port GPIOB
#define RTC_INTERRUPT_EXTI_IRQn EXTI9_5_IRQn
